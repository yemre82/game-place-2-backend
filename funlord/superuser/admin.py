...
class NewsAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'short_description',
                    'description', 'image', 'created_at', 'update_at')
...
class CompanyAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'image', 'created_at', 'update_at')
...
class BranchsAdmin(admin.ModelAdmin):
    list_display = ('id', 'city', 'country', 'maps_link',
...
class addingBalanceCampaignsAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'amount_money', 'is_active', 'gift_price',
                    'is_have_discount', 'discount_percentage', 'created_at', 'update_at')
    search_fields = ('id', 'name', 'amount_money',
                     'gift_price', 'discount_percentage')
...
class JetonHistoryAdmin(admin.ModelAdmin):
    list_display = ('id', 'user', 'jeton_amount',
                    'is_added_jeton', 'created_at', 'updated_at')
